...
namespace bsio { namespace internal {
    ...
    private:
        ...
        {
            if (BaseSessionBuilder<Derived>::mOption->dataHandler == nullptr)
            {
        ...
        void endAsyncConnect() override
        {
            ...
            *newOption = *BaseSessionBuilder<Derived>::mOption;
        ...
        void        settingEstablishHandle()
        {
            internal::BaseSocketConnectBuilder<Derived>::mOption.establishHandler = 
                [option = internal::BaseSessionBuilder<Derived>::mOption](asio::ip::tcp::socket socket)
            {
